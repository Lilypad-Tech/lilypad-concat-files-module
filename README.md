...
Lilypad modules can declare required and optional file inputs to a job. The required inputs must be present or the job will be rejected. No other files beyond the required and optional files are permitted.
